...
<style>
body {  background:url("myimages/bg2.jpg");}
                ...
                <div class="panel-heading display-table" >
                    <div class="row display-tr" >
                        ...
                        <div class="display-td" >                            
                            <img class="img-responsive pull-right" src="myimages2/paymen.png">
                        </div>
                    </div>                    
                </div>
...
<input type="hidden" name="quantity" id="quantity" class="form-control" value="<?php echo $_POST['quantity'];?>">
		<input type="hidden" name="total" id="total" class="form-control" value="<?php echo $_POST['total'];?>">
						...
						<div class="row">
                            <div class="col-xs-12">
                                <input type="submit" class="btn btn-success btn-lg btn-block" name="cod" value="Cash">
							</div>
                        </div>
                    </form>
...
$query="insert into booking(bookingdate,customername,emailid,contact,city,address,productname,price,quantity,total,status,type) values('$bookingdate','$customername','$emailid','$contact','$city','$address','$productname','$sprice','$quantity','$total','pending','ordinary')";
$n = my_iud($query);
if($n==1)
{
