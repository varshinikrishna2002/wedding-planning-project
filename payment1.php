            ...
            <div class="panel panel-default credit-card-box">
                ...
                <div class="panel-body">
                    <form method="POST">
						             ...
						             <input type="hidden" name="photo" id="photo" class="form-control" value = "<?php echo $_POST['photo']; ?>">
									 <input type="hidden" name="msg" id="msg" class="form-control" value = "<?php echo $_POST['msg']; ?>">
...
$query="insert into booking(bookingdate,customername,emailid,contact,city,address,productname,price,quantity,total,status,type,image,message) values('$bookingdate','$customername','$emailid','$contact','$city','$address','$productname','$sprice','$quantity','$total','pending','personal','$img','$msg')";
$n = my_iud($query);
if($n==1)
{
